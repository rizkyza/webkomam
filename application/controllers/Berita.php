...
class Berita extends CI_Controller {
...
</button>Berita tidak ditemukan</b></div>');
			redirect('/','refresh');
		}
	}
	...
	public function komen($id) {
        ...
        <button type="button" class="close" data-dismiss="alert">&times;
</button>Komentar berhasil terkirim dan akan diverifikasi Admin terlebih dahulu</b></div>');
	...
	public function kategori($id) {
		...
		/* menyiapkan data yang akan disertakan/ ditampilkan pada view */
		$this->data['page'] = "Kategori Berita: $kat";
