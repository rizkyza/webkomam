          ...
          <div class="box box-primary">
            <div class="box-body">
              <div class="row">
                ...
                <div class="form-group"><label>Nama Kantor Kesehatan</label>
                  <?php echo form_input($nama_kesehatan);?>
                </div>
                <div class="form-group"><label>Desa</label>
                  <?php echo form_dropdown('', $get_combo_data_desa, '', $desa); ?>
                </div>
        ...
        <div class="col-md-6">
          <div class="box box-primary">
            <div class="box-body">
              ...
              <div class="form-group"><label>Gambar Kantor Kesehatan</label>
                ...
                <br><p><b>Preview Gambar Kantor Kesehatan</b></p><br> 
