          ...
          <div class="box box-primary">
            <div class="box-body">
              <div class="form-group"><label>Nama Kategori Sekolah</label>
                <?php echo form_input($nama_kategori_sekolah, $kategori_sekolah->nama_kategori_sekolah);?>
              </div>
            </div>
            <?php echo form_input($id_kategori_sekolah,$kategori_sekolah->id_kategori_sekolah);?>
