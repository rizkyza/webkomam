      ...
      <?php echo form_open_multipart($action);?>
        ...
        <div class="col-md-6">
          <div class="box box-primary">
            <div class="box-body">
              <div class="form-group"><label>Visi</label>
                <?php echo form_textarea($visi, $vimi->visi);?>
              </div>
              <div class="form-group"><label>Misi</label>
                <?php echo form_textarea($misi, $vimi->misi);?>
              </div>
            </div>
            <?php echo form_input($id_vimi,$vimi->id_vimi);?>
