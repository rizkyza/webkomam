            ...
            <div class="box-body">
              <div class="row">
                ...
                <div class="form-group"><label>Nama Kategori Sekolah</label>
                  <?php echo form_dropdown('', $get_combo_kategori_sekolah, '', $nama_kategori_sekolah); ?>
                </div>
                ...
                <div class="form-group"><label>Jumlah Siswa</label>
                  <?php echo form_input($jumlah_siswa);?>
                </div>
        ...
        <div class="col-md-6">
          <div class="box box-primary">
            <div class="box-body">
              ...
              <div class="form-group"><label>Gambar Sekolah</label>
                ...
                <br><p><b>Preview Gambar Sekolah</b></p><br> 
