            ...
            <div class="box-body">
              <div class="row">
                ...
                <div class="form-group"><label>Jenis Kelamin</label>
                  <?php echo form_dropdown('', $options_jenis_kelamin,'',$jenis_kelamin);?>
                </div>
                <div class="form-group"><label>Golongan Darah</label>
                  <?php echo form_dropdown('', $options_gol_darah,'',$gol_darah);?>
                </div>
                <div class="form-group"><label>Alamat</label>
                  <?php echo form_input($alamat);?>
                </div>
                <div class="form-group"><label>Kelurahan / Desa</label>
                  <?php echo form_dropdown('', $get_combo_data_desa, '', $kel_desa); ?>
                </div>
                <div class="form-group"><label>Kecamatan</label>
                  <?php echo form_input($kecamatan);?>
                </div>
                <div class="form-group"><label>Agama</label>
                  <?php echo form_dropdown('', $options_agama,'',$agama);?>
                </div>
                <div class="form-group"><label>Status</label>
                  <?php echo form_dropdown('', $options_status,'',$status_perkawinan);?>
                </div>
                <div class="form-group"><label>Pekerjaan</label>
                  <?php echo form_dropdown('', $options_pekerjaan,'',$pekerjaan);?>
                </div>
                <div class="form-group"><label>Kewarganegaraan</label>
                  <?php echo form_input($kewarganegaraan);?>
                </div>
