      ...
      <?php echo form_open_multipart($action);?>
        ...
        <div class="col-md-6">
          <div class="box box-primary">
            <div class="box-body">
              <div class="form-group"><label>Item Menu Data</label>
                <?php echo form_input($itemmenu, $itemmenu_data->itemmenu);?>
              </div>
            </div>
            <?php echo form_input($id_itemmenu_data,$itemmenu_data->id_itemmenu_data);?>
