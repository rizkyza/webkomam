		...
		<div class="col-md-8">
			...
			<div class="row">
			  <div class="col-md-12">
			    <div class="thumbnail">
<?php
if (empty($berita->userfile)) {echo "<img src='".base_url()."assets/images/no_image_thumb.png' width='400' height='200'>";} else {echo " <img src='".base_url()."assets/images/berita/".$berita->userfile.$berita->userfile_type."' alt='$berita->userfile' title='$berita->userfile'> ";}
?>
			      <div align="right">
				   ...
				   <div class="box-body">
				     <fieldset>
				       ...
				       <div class="form-group">
				         ...
				         <div class="col-lg-10"><?php echo $cap_img;?>
...
foreach ($get_all_random as $post_random) {
	...
	<div class="col-sm-6 col-md-6">
																								  <div class="thumbnail">
	<?php
	if (empty($post_random->userfile)) {echo "<img src='".base_url()."assets/images/no_image_thumb.png' width='400' height='200'>";} else {echo " <img src='".base_url()."assets/images/berita/".$post_random->userfile.'_thumb'.$post_random->userfile_type."'> ";}
	?>
	  <div align="right">
