...
{
  public $table = 'kepala_desa';
  public $id    = 'id_kepala_desa';
  public $order = 'DESC';
  ...
  function get_combo_kepala_desa()
  {
    $this->db->order_by('nama_kepala_desa', 'ASC');
    ...
    if($query->num_rows() > 0){
      ...
      {
        $data[$row['id_kepala_desa']] = $row['nama_kepala_desa'];
      }
      return $data;
    }
  }
  ...
  function get_by_id($id)
  {
    ...
    $this->db->or_where('nama_kepala_desa_seo', $id);
  ...
  // get all
  function get_cari_kepala_desa()
  {
    $cari_berita = $this->input->post('cari_kepala_desa');

    $this->db->like('nama_kepala_desa', $cari_kepala_desa);
    return $this->db->get($this->table)->result();
  }
