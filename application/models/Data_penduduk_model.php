...
class data_penduduk_model extends CI_Model
{
  ...
  function get_combo_data_penduduk()
  {
  ...
  // get all
  function get_cari_data_penduduk()
  {
    $cari_data_penduduk = $this->input->post('cari_data_penduduk');

    $this->db->like('nama', $cari_data_penduduk);
    return $this->db->get($this->table)->result();
  }
