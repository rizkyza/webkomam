...
class data_pejabat_model extends CI_Model
{
  ...
  function get_combo_data_pejabat()
  {
    ...
    if($query->num_rows() > 0){
      ...
      {
        $data[$row['id_pejabat']] = $row['jabatan'];
      }
      return $data;
    }
  }
  ...
  // get all
  function get_cari_data_pejabat()
  {
    $cari_data_pejabat = $this->input->post('cari_data_pejabat');

    $this->db->like('jabatan', $cari_data_pejabat);
    return $this->db->get($this->table)->result();
  }
