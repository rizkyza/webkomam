...
class data_sekolah_model extends CI_Model
{
  ...
  function get_combo_data_sekolah()
  {
  ...
  function get_by_id($id)
  {
    ...
    $this->db->or_where('nama_sekolah_seo', $id);
  ...
  // get all
  function get_cari_data_sekolah()
  {
    $cari_data_sekolah = $this->input->post('cari_data_sekolah');

    $this->db->like('nama_sekolah', $cari_data_sekolah);
    return $this->db->get($this->table)->result();
  }
